CREATE DATABASE  IF NOT EXISTS `design-1c-class_management` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `design-1c-class_management`;
...
CREATE TABLE `students` (
  `id` int NOT NULL AUTO_INCREMENT,
  `student_number` varchar(16) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `reset_token_expiration` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,'admin','admin@mail.com','$2y$10$wbxeIP67cpiRJjkz1MnjneHfam1u0kzzkq5Ids3/yDrgVbNmxmoyq','admin','2024-02-08 09:53:37','','');
...
-- Dump completed on 2024-04-30 17:31:31
